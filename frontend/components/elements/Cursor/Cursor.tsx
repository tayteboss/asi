...
const CursorRing = styled(motion.div)<StyledProps>`
	...
	top: ${(props) => (props.$isHoveringLink ? '-15px' : '-20px')};
	left: ${(props) => (props.$isHoveringLink ? '-15px' : '-20px')};
...
const SmallRing = styled(motion.div)<StyledProps>`
	position: fixed;
	display: flex;
	flex-flow: row;
	align-content: center;
